...
<head>
    ...
    <title>{{ config('app.name', 'HR System') }} - {{ __('messages.super_admin') ?? 'Super Admin' }}</title>
...
<body class="bg-gray-50 text-gray-900 antialiased min-h-screen flex flex-col" x-data="{ mobileMenu: false }">
    ...
    <nav class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 py-3 px-6 shadow-sm">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-10 flex justify-between items-center h-16">
            ...
            <div class="md:hidden flex items-center">
                <button @click="mobileMenu = !mobileMenu" class="p-2 text-gray-500 hover:text-secondary focus:outline-none transition-colors">
        ...
        <div x-show="mobileMenu" 
             ...
             class="md:hidden border-t border-gray-100 bg-white py-4 px-6 space-y-4"
             x-cloak>
    ...
    <main class="flex-grow max-w-full mx-auto px-4 sm:px-6 lg:px-10 w-full py-8">
        @yield('content')
    </main>

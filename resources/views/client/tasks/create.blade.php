...
<div class="pt-8 pb-12">
    <div class="max-w-full mx-auto">
        ...
        <x-dashboard-sub-header 
            :title="__('messages.add_task')" 
            :subtitle="__('messages.create_task_desc')"
        ...
        />
            ...
            <div
                ...
                <form method="POST" action="{{ route('client.tasks.store') }}" enctype="multipart/form-data" class="p-12 space-y-16">
                    @csrf

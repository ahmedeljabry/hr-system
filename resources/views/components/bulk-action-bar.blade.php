...
>
    <div class="flex items-center gap-10">
        ...
        <div class="flex items-center gap-4">
            ...
            <button 
                x-show="deleteEndpoint" 
                @click="bulkDelete" 
                class="group relative inline-flex items-center gap-3 px-8 py-3 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white font-black rounded-xl border border-red-500/20 hover:border-red-500 shadow-lg transition-all duration-300 overflow-hidden"
            >

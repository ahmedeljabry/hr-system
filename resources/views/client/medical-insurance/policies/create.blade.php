...
<div class="pt-8 pb-12" x-data="{ 
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <form action="{{ route('client.medical-insurance.policies.store', ['client_slug' => request('client_slug')]) }}" method="POST" class="space-y-8">
            @csrf

            <!-- Basic Policy Info -->
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100">
                <h2 class="text-xl font-black text-secondary mb-6 border-b pb-4">{{ __('messages.personal_information') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="policy_number" required class="block w-full px-5 py-4 text-sm font-bold border-2 border-gray-100 rounded-2xl focus:ring-0 focus:border-primary/30 transition-all bg-gray-50 focus:bg-white text-secondary" placeholder="POL-123456">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="start_date" required class="block w-full px-5 py-4 text-sm font-bold border-2 border-gray-100 rounded-2xl focus:ring-0 focus:border-primary/30 transition-all bg-gray-50 focus:bg-white text-secondary">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" required class="block w-full px-5 py-4 text-sm font-bold border-2 border-gray-100 rounded-2xl focus:ring-0 focus:border-primary/30 transition-all bg-gray-50 focus:bg-white text-secondary">
                    </div>
                </div>
            </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <input type="number" :name="'assigned_employees[' + index + '][cost]'" x-model="emp.cost" required step="0.01" min="0"
                                                   class="w-32 px-4 py-2 text-xs font-bold border-2 border-gray-100 rounded-xl focus:ring-0 focus:border-primary/30 transition-all bg-gray-50 focus:bg-white"
                                                   placeholder="0.00">
                                            <span class="text-[10px] font-black text-gray-400 tracking-widest">{{ __('messages.currency_sar') }}</span>
                                        </div>
                                    </td>

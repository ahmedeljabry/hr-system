# login system Development Guidelines

Auto-generated from all feature plans. Last updated: 2026-04-05

## Active Technologies
- MySQL 8 / SQLite (for testing), Local `private` storage disk. (002-employee-management)
- PHP 8.3 (Laravel 11) + Maatwebsite/Laravel-Excel, Alpine.js, Blade templates (002-employee-management)
- MySQL 8 (production) / SQLite (testing), Local `private` storage disk for file uploads (002-employee-management)
...
# Add commands for PHP 8.3 (Laravel 11)

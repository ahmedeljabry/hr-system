...
<div class="max-w-3xl mx-auto">
    <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">{{ __('messages.add_employee') }}</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form method="POST" action="{{ route('client.employees.store') }}" enctype="multipart/form-data" class="p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        <input type="number" name="basic_salary" id="basic_salary" step="0.01" value="{{ old('basic_salary') }}" required
